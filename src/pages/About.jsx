      ...
      <div className="section-contacto-about">
        ...
        <div className="container-texto-about">
          ...
          <div className="category-professional">
            ...
            <div className="año-desplegable">
              ...
              <div className="content">
                ...
                <p className="parrafo-contacto-about">
                  <b>El Banquete</b>Diseño de escenografía y vestuario. Estreno
                  en Nave 73. Ferviente compañía Dirección Adrián Pulido.
                </p>
              </div>
            </div>
            <hr />
            <div className="año-desplegable">
              ...
              <div className="content">
                ...
                <p className="parrafo-contacto-about">
                  ...
                  vestuario. En Teatro Español y Teatro Quique San Francisco
          ...
          <div className="año-desplegable">
            ...
            <div className="content">
              <p className="parrafo-contacto-about">
                <b>Kelly Deli.</b>Diseño, desarrollo y coordinación de montaje
                de 17 Kioscos de Sushi para Carrefour y 3 para El Corte Inglés.
              </p>
              <p className="parrafo-contacto-about">
                <b>Anine Bing</b>Diseño para shop in shop en El Corte Inglés.
              </p>
              <p className="parrafo-contacto-about">
          ...
          <div className="año-desplegable">
            ...
            <div className="content">
              ...
              <p className="parrafo-contacto-about">
                <b>Logista.</b>Creación, diseño y desarrollo de nuevo modelo de
                estanco. Mobiliario e interiorismo.
              </p>
              <p className="parrafo-contacto-about">
          ...
          <div className="año-desplegable">
            ...
            <div className="content">
              ...
              <p className="parrafo-contacto-about">
                <b>Viceroy</b>Desarrollo de 17 tiendas tipo y 49 elementos de
                mobiliario para El Corte Inglés.
              </p>
              <p className="parrafo-contacto-about">
                <b>Gran Optic.</b>Mobiliario a medida para las dos ópticas de la
                marca.
              </p>
            </div>
          </div>
          ...
          <div className="año-desplegable">
            ...
            <div className="content">
              ...
              <p className="parrafo-contacto-about">
                <b>Sincio.</b>Restaurante en el mercado de Antón Martín 30 m2.
              </p>
            </div>
          </div>
          <hr />
          <div className="año-desplegable">
            ...
            <div className="content">
              ...
              <p className="parrafo-contacto-about">
                <b>Gran Optic Vallecas.</b>Óptica en la avenida de la Albufera.
                120 m2.
              </p>
            </div>
          </div>
          ...
          <div className="año-desplegable">
            ...
            <div className="content">
              <p className="parrafo-contacto-about">
                ...
                TeatrodelaComedia. Dirigido por Lluís Homar para la Compañía
                Nacional de Teatro Clásico. Estreno en Festival de Almagro.
                Teatro de la Comedia y Teatre Romea.
              </p>
            </div>
          </div>
          <hr />
          <div className="año-desplegable">
            ...
            <div className="content">
              ...
              <p className="parrafo-contacto-about">
                <b>Algunos días</b>
                Centro Dramático Nacional. Teatro María Guerrero. Texto:Cristina
                Rojas. Dirección: Cristina Rojas para la compañía Tenemos gato
              </p>
            </div>
          </div>
          <hr />
          <div className="año-desplegable">
            ...
            <div className="content">
              ...
              <p className="parrafo-contacto-about">
                <b>Hoax Hamlet. </b>
                Ciudad de la Cultura. Compañía: Voadora. Dirección Hugo Torres.
              </p>
            </div>
          </div>
          <hr />
          <div className="año-desplegable">
            ...
            <div className="content">
              <p className="parrafo-contacto-about">
                ...
                Sevilla. Texto: Fernando Delgado-Hierro. Dirección: Juan Ceacero
                para la compañía Exlímite.
              </p>
              <p className="parrafo-contacto-about">
                <b>Los Remedios. </b>
                Centro Dramático Nacional. Teatro María Guerrero. Sala de la
                Princesa. Texto: Fernando Delgado. Dirección: Juan Ceacero, para
                la compañía Exlímite. Reestrenado en Teatro Lara.{" "}
          ...
          <div className="año-desplegable">
            ...
            <div className="content">
              <p className="parrafo-contacto-about">
                ...
                Teatro Español y Teatro Quique San Francisco. Texto y dirección:
                Javier Ballesteros.
              </p>
              <p className="parrafo-contacto-about">
                <b>Poema de sangre. </b>
          ...
          <div className="año-desplegable">
            ...
            <div className="content">
              <p className="parrafo-contacto-about">
                <b>Moongate. </b>
                Sala Valle Incán RESAD, Madrid. Texto y dirección: Jorge Navarro
                de Lemus.
              </p>
              <p className="parrafo-contacto-about">
          ...
          <div className="año-desplegable">
            ...
            <div className="content">
              ...
              <p className="parrafo-contacto-about">
                ...
                Festival internacional de teatro de Spoleto, Italia. Dirección:
                Antonio Urbano.
              </p>
            </div>
          </div>
