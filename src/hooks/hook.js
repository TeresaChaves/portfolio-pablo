 ...
 const obras = {
    cucaracha: {
      title: "Cucaracha || Pablo Chaves",
         description: "Obra 'Cucaracha' de Pablo Chaves, una reflexión escénica intensa.",
      ficha: (
    ...
    gaviotas: {
      title: "Gaviotas || Pablo Chaves",
        description: "Obra 'Gaviotas' de Pablo Chaves, explorando la libertad y el mar.",
        ficha: (
             <div className="container-ficha-centrada">
          <i className="name-ficha">
            {" "}
        ...
        fichaMobile:( <div className="container-ficha-centrada">
          <i className="name-ficha">
            {" "}
            <i className="name-ficha">Estrenada en Exlímite y Nave 73</i>
          </i>
    ...
    marcela: {
      title: "Marcela || Pablo Chaves",
        description: "Obra 'Marcela' de Pablo Chaves, explorando la libertad y el mar.",    
        ficha: (
            <div className="container-ficha-centrada">
                {" "}
     ...
     colaDePez: {
         ...
         description: "Proyecto Cola de Pez de Pablo Chaves en Bastero Kulturgunea.",
         ficha: (
             <div className="container-ficha-centrada">
    ...
    laFortaleza:{
         ...
         ficha: ( <div className="container-ficha-centrada">
              <i>
     ...
     description: "Proyecto Domesticación de Pablo Chaves estrenada en los Teatros del Canal",
     ficha:(<div className="container-ficha-centrada">
    ...
    fichaMobile: (<div className="container-ficha-centrada">
     ...
     description: "Proyecto El Banquete escenografía de Pablo Chaves estrenada en Exlímite y Nave 73",
     ficha: (<div className="container-ficha-centrada">
          <i className="name-ficha">Estrenada en Exlímite y Nave 73</i>
          <i>
